...
SPECS: List[SfxSpec] = [
    ...
    _s("ambient", "world", "A calm gentle outdoor meadow ambience, soft breeze and a few faraway birds, peaceful, seamless loop.", 12.0, loop=True, volume=0.18),
    ...
    _s("belt_loop", "factory", "A gentle steady soft rhythmic conveyor belt mechanical hum, smooth, low, seamless loop.", 4.0, loop=True, volume=0.22),

    # ---- car --------------------------------------------------------------
    _s("car_ready", "car", "A cute toy car engine rev followed by a happy little chime, friendly.", 1.8, volume=0.65),
    _s("drive_loop", "car", "A small friendly toy car engine idling and driving, soft cartoon motor, seamless loop.", 4.0, loop=True, volume=0.3),
